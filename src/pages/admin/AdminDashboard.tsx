...
const recentUsers = [
  { name: "Marie Dupont", email: "marie@email.com", role: "Chercheur", date: "Il y a 2h" },
  { name: "Pierre Martin", email: "pierre@techco.com", role: "Recruteur", date: "Il y a 5h" },
  { name: "Sophie Leroy", email: "sophie@email.com", role: "Chercheur", date: "Il y a 8h" },
  { name: "Lucas Bernard", email: "lucas@startup.io", role: "Recruteur", date: "Il y a 1j" },
  { name: "Emma Moreau", email: "emma@email.com", role: "Chercheur", date: "Il y a 1j" },
];
    ...
    <DashboardLayout role="admin" title="Tableau de bord">
      ...
      <div className="mt-8 rounded-xl border border-border bg-card">
        <div className="border-b border-border px-6 py-4">
          <h2 className="font-heading text-lg font-semibold text-foreground">Derniers inscrits</h2>
        </div>
          ...
          {recentUsers.map((u) => (
            <div key={u.email} className="flex items-center justify-between px-6 py-4">
              ...
              <div className="text-right">
                <span className={`inline-block rounded-full px-2 py-0.5 text-xs font-medium ${u.role === "Recruteur" ? "bg-accent/10 text-accent" : "bg-primary/10 text-primary"}`}>
                  {u.role}
                </span>
