            ...
            <div className="flex flex-col gap-4 md:flex-row md:items-end md:justify-between">
              <div>
                ...
                <div className="mt-4 flex flex-wrap gap-4 text-sm text-muted-foreground">
                  ...
                  <span className="flex items-center gap-1">
                    <Users className="h-4 w-4" /> {company.size} employés
                  </span>
                  <span className="flex items-center gap-1">
                    <Calendar className="h-4 w-4" /> Fondée en {company.founded}
                  </span>
                  <span className="flex items-center gap-1">
        ...
        <div className="grid gap-8 lg:grid-cols-3">
          ...
          <div className="rounded-2xl border border-border bg-card p-8">
            ...
            <dl className="mt-4 space-y-3 text-sm">
              ...
              <div className="flex justify-between">
                <dt className="text-muted-foreground">Fondée</dt>
                <dd className="font-medium text-foreground">
                  {company.founded}
                </dd>
              </div>
              <div className="flex justify-between">
                <dt className="text-muted-foreground">Offres</dt>
                <dd className="font-medium text-primary">
                  {jobs.length} ouverte{jobs.length > 1 ? "s" : ""}
                </dd>
              </div>
            </dl>
          </div>
