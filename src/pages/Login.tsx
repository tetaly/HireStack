...
const Login = () => {
  ...
  const handleDemoLogin = (role: "admin" | "recruiter" | "seeker") => {
    ...
    <div className="flex min-h-screen">
      ...
      <div className="flex w-full items-center justify-center px-6 lg:w-1/2">
        <div className="w-full max-w-md">
          ...
          <h1 className="mb-2 font-heading text-2xl font-bold text-foreground">Se connecter</h1>
          ...
          <form className="space-y-4" onSubmit={(e) => e.preventDefault()}>
            ...
            <Button variant="hero" className="w-full" size="lg">Se connecter</Button>
          </form>

          <div className="my-6 flex items-center gap-3">
            <div className="h-px flex-1 bg-border" />
            <span className="text-xs text-muted-foreground">Accès démo rapide</span>
            <div className="h-px flex-1 bg-border" />
          </div>
          ...
          <div className="grid grid-cols-3 gap-2">
            ...
            <Button variant="outline" size="sm" onClick={() => handleDemoLogin("recruiter")} className="text-xs">
              Recruteur
            </Button>
            <Button variant="outline" size="sm" onClick={() => handleDemoLogin("seeker")} className="text-xs">
              Chercheur
            </Button>
          </div>
